...
(function($){
    ...
    $(document).ready(function(){
		...
		// start preloading		
		if( $('.ut-portfolio-featured-image').length ) {
			
            var preloadImages = document.querySelector('.ut-portfolio-featured-image');
		...
		function utResetContent( portfolio_single_id ) {
            ...
            if( $("#ut-portfolio-detail-"+portfolio_single_id).data('lightGallery') ) {                
                $("#ut-portfolio-detail-"+portfolio_single_id).data('lightGallery').destroy(true);                
            }
