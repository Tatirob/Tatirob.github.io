		...
		if ( 0 < count( $field_data ) ) {
			...
			foreach ( $field_data as $k => $v ) {
                ...
                if( $v['type'] == 'showcase_info' ) {
					...
					$html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Portfolio Animation In Style' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[animation_in]" id="' . esc_attr( $k ) . '_animation_in">';
					...
					/* filter spacing */
                    $html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Gallery Filter Spacing' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[filter_spacing]" id="' . esc_attr( $k ) . '_filter_spacing">';
					...
					/* filter font size */
					$html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Filter Font Size' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[filter_font_size]" id="' . esc_attr( $k ) . '_filter_font_size">';
                    ...
                    /* letter spacing */
                    $html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Filter Letter Spacing' , 'ut_portfolio_lang') . '</th>';
					...
					$html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Portfolio Animation Out Style' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><select name="' . esc_attr( $k ) . '[animation_out]" id="' . esc_attr( $k ) . '_animation_out">';
					...
					/* text color */
                    $html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Portfolio Background Color' , 'ut_portfolio_lang') . '</th>';
                        $html .= '<td><input value="' . $this->validate_value( $data , 'background_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[background_color]" id="' . esc_attr( $k ) . '_background_color" /> <label for="' . esc_attr( $k ) . '_background_color"></label>';
                    ...
                    $html .= '<tr valign="top">';
                        ...
                        $html .= '<td><input value="' . $this->validate_value( $data , 'text_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[text_color]" id="' . esc_attr( $k ) . '_text_color" /> <label for="' . esc_attr( $k ) . '_text_color"></label>';
                    ...
                    $html .= '<tr valign="top">';
                        ...
                        $html .= '<td><input value="' . $this->validate_value( $data , 'title_background_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[title_background_color]" id="' . esc_attr( $k ) . '_title_background_color" /> <label for="' . esc_attr( $k ) . '_title_background_color"></label>';
                    ...
                    $html .= '<tr valign="top">';
                        ...
                        $html .= '<td><input value="' . $this->validate_value( $data , 'category_color' ) . '" data-mode="rgb" class="color-picker-hex wp-color-picker ut_color_picker" name="' . esc_attr( $k ) . '[category_color]" id="' . esc_attr( $k ) . '_category_color" /> <label for="' . esc_attr( $k ) . '_category_color"></label>';                        
