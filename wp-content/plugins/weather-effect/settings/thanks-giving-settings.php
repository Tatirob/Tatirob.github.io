		...
		<div id="thanksgiving_weather_effect" class="tab-content">
			...
			<div class="row" style="padding-left: 10px;">&nbsp;&nbsp;&nbsp;
				...
				<p class="range-slider padding_settings">
					<input id="thanksgiving_min_size_leaf" name="thanksgiving_min_size_leaf" class="range-slider__range" type="range" value="<?php echo $thanksgiving_min_size_leaf; ?>" min="1" step="1" max="30">
			...
			<div class="row" style="padding-left: 10px;">&nbsp;&nbsp;&nbsp;
				...
				<p class="range-slider padding_settings">
					<input id="thanksgiving_max_size_leaf" name="thanksgiving_max_size_leaf" class="range-slider__range" type="range" value="<?php echo $thanksgiving_max_size_leaf; ?>" min="10" step="1" max="200">
					<span class="range-slider__value">0</span>
				</p>
			</div>
			<div class="row" style="padding-left: 10px;">&nbsp;&nbsp;&nbsp;
				...
				<p class="range-slider padding_settings">
					<input id="thanksgiving_flakes_leaf" name="thanksgiving_flakes_leaf" class="range-slider__range" type="range" value="<?php echo $thanksgiving_flakes_leaf; ?>" min="1" step="1" max="10">
					<span class="range-slider__value">0</span>
				</p>
			</div>
			<div class="row" style="padding-left: 10px;">&nbsp;&nbsp;&nbsp;
				...
				<p class="range-slider padding_settings">
					<input id="thanksgiving_speed" name="thanksgiving_speed" class="range-slider__range" type="range" value="<?php echo $thanksgiving_speed; ?>" min="1" step="1" max="10">
					<span class="range-slider__value">0</span>
				</p>
			</div>
		</div>
