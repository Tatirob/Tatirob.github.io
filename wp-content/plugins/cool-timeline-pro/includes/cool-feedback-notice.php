...
if (!class_exists('CoolFeedbackNotice')) {
	...
	public function load_script() {
		wp_register_script( 'feedback-notice-script', CTP_PLUGIN_URL. '/js/ctl-admin-feedback-notice.js', array( 'jquery' ),null, true );
        wp_enqueue_script( 'feedback-notice-script' );
        wp_register_style( 'feedback-notice-styles',CTP_PLUGIN_URL.'/css/ctl-admin-feedback-notice.css' );
    ...
    public function admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        $img_path=CTP_PLUGIN_URL.'/images/cool-timeline-logo.png';
