...
function ctl_common_assets(){
    ...
    wp_register_script('ctl-masonry', CTP_PLUGIN_URL . 'js/masonry.pkgd.min.js', array('jquery'), null);
    wp_register_script('ctl-compact-js', CTP_PLUGIN_URL . 'js/ctl_compact_scripts.js', array('jquery','ctl-masonry'), null);
            ...
            wp_register_script('ctl-slick-js',CTP_PLUGIN_URL . 'js/slick.min.js', array('jquery'), null, true);
