<?php
    ...
    function ctl_stories_load_more_handler() {
        ...
        require(CTP_PLUGIN_DIR.'/includes/cool-timeline-custom-styles.php');
        ...
        require(CTP_PLUGIN_DIR.'/includes/ctl-build-query.php');
        $args['paged']=esc_attr( $_POST['page'] );
        //load main vertical story timeline story content
        require(CTP_PLUGIN_DIR.'/includes/views/story-vertical-layout.php');
