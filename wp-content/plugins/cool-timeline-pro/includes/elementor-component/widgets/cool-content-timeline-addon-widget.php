		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'bounceInUp'=>__('bounceInUp','cool-timeline' ),
					'bounceInDown'=>__( 'bounceInDown' ,'cool-timeline'),
					'bounceInLeft' => __( 'bounceInLeft','cool-timeline' ),
					'bounceInRight' => __( 'bounceInRight','cool-timeline' ) ,
					'slideInDown' => __( 'slideInDown','cool-timeline') ,
					'slideInUp' => __( 'slideInUp','cool-timeline' ) ,
					'slideInLeft' => __( 'slideInLeft','cool-timeline') ,
					'slideInRight' => __( 'slideInRight','cool-timeline' ),
					'shake' => __( 'shake','cool-timeline') ,
					'wobble' => __( 'wobble','cool-timeline' ) ,
					'swing' => __( "swing",'cool-timeline') ,
					'jello' => __( "jello",'cool-timeline' ) ,
					'flip' => __( "flip",'cool-timeline') ,
					'fadein' => __( "fadein",'cool-timeline') ,
					'rotatein' => __( "rotatein",'cool-timeline') ,
				],
				'condition'   => [
                    'timeline_layout!'   => 'horizontal',
                ],
