    ...
    class CoolTimelinePro {
        ...
        function clt_flush_rewrite_rules_after_activation(){
         ...
         function ctl_custom_order_js($hook) {
          ...
          public function clt_include_files(){
           // Register cooltimeline post type for timeline stories
            require_once CTP_PLUGIN_DIR . 'includes/cool-timeline-posttype.php';
            // contain common function for plugin
            require_once CTP_PLUGIN_DIR . 'includes/ctl-helpers.php';
            require_once CTP_PLUGIN_DIR . 'includes/ctl-load-more.php';
         ...
         if(is_admin()){
            ...
            require CTP_PLUGIN_DIR .'/includes/cool-feedback-notice.php';
            /*
             * Options panel
             */
            ctl_option_panel();
            ...
            require_once CTP_PLUGIN_DIR . 'includes/cool-timeline-shortcode.php';
            require_once CTP_PLUGIN_DIR . 'includes/cool-content-timeline-shortcode.php';
            require_once CTP_PLUGIN_DIR . 'includes/cool-timeline-custom-styles.php';
