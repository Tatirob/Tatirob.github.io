                    ...
                    foreach ( $aArrayOfValues as $sKey => $aValue ) {
                        ...
                        if ( !empty($aValue['image_id']) ) {
                            ...
                            if ( ! empty( $sSelectValue ) ) {
                                echo '<option data-thumbimageuri="'.esc_attr($aImageThumb[0]).'" data-imagetitle="'.$sThisOptionLabel.'" data-fullimageuri="'.esc_attr($aImageFull[0]).'" data-imageuri="'.esc_attr($aImage[0]).'" data-imagesrcset="'.esc_attr($sImageSrcset).'" data-imagesizes="'.esc_attr($sImageSizes).'"'.selected( $aValue['slug'], $sSelectValue, false ).' value="'.esc_attr($aValue['slug']).'">';
                            } else {
