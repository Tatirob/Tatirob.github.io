            ...
            $css_style = '<style type="text/css" scoped>';
                ...
                if( !empty( $font_size ) && $class == 'bklyn-btn-header' ) {
					...
					if( strpos( $font_size, 'px' ) !== false ) {
						...
						$css_style .= '#' . $button_id . ' a { font-size:' . $font_size . ' !important; }';
						
					} else {
						
						$css_style .= '#' . $button_id . ' a { font-size:' . $font_size . 'px !important; }';
                ...
                if( !empty( $letter_spacing ) ) {
					...
					if( strpos( $letter_spacing, 'em' ) !== false ) {
						...
						$css_style .= '#' . $button_id . ' a { letter-spacing:' . $letter_spacing . '; }';
