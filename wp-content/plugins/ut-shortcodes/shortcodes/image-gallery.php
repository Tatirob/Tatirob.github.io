            ...
            <script type="text/javascript">
                ...
                (function($){
                    ...
                    $(document).ready(function(){
						...
						<?php if( $lazy == 'true' && ( $animate == 'false' || ( $animate == 'true' && !$effect ) ) ) : ?>
						
							$("#<?php echo esc_attr( $id ); ?> .ut-image-gallery-item").appear();						
						
							$(document.body).on('appear', '#<?php echo esc_attr( $id ); ?> .ut-image-gallery-item', function( event, $all_appeared_elements ) {
