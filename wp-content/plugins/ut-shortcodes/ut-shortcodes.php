...
define('UT_SHORTCODES_VERSION', '4.7.3.2');
...
function ut_shortcodes_enqueuestyles() {
    ...
    if( !is_admin() ) {
        ...
        // main shortcode css
		$ut_shortcodes = get_template_directory_uri() . '/css/ut.shortcode' . $min . '.css';
		wp_enqueue_style( 'ut-shortcodes' , $ut_shortcodes );				
        
        // visual composer css
		$ut_vc_shortcodes = get_template_directory_uri() . '/css/ut.vc.shortcodes' . $min . '.css';
