...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/admin-bar.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/contact-form-7/includes/js/scripts.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/ut-portfolio/assets/vendor/lightGallery/js/lightgallery-all.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/ut-shortcodes/js/ut.scplugin.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/woocommerce/assets/js/frontend/single-product.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/yith-woocommerce-compare/assets/js/woocompare.min.js\n- Error message: "+ e.message);}
try{
/*!
	Colorbox 1.6.1
	license: MIT
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/yith-woocommerce-compare/assets/js/jquery.colorbox-min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/woocommerce/assets/js/prettyPhoto/jquery.prettyPhoto.min.js\n- Error message: "+ e.message);}
try{
/**
 * jQuery SelectBox
 *
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/yith-woocommerce-wishlist/assets/js/jquery.selectBox.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/yith-woocommerce-wishlist/assets/js/jquery.yith-wcwl.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/themes/brooklyn/js/superfish.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/themes/brooklyn/js/simplebar/simplebar.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/themes/brooklyn/js/ut-init.min.js\n- Error message: "+ e.message);}
try{
//     Underscore.js 1.8.3
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/underscore.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/wp-util.min.js\n- Error message: "+ e.message);}
try{
var UniCpo;
...
if (status=== 'OK'){
if (results[0]){
jQuery( idField ).val( results[0].formatted_address )}else {
console.info('No results found')}}else {
...
if ( field_name ){
jQuery( '[name='+field_name+']' ).val( route.legs[0].start_address )}else {
...
origin=obj.getPosition()}else {
destination=obj.getPosition()}});
directionsService.route({
origin: origin,
destination: destination,
travelMode: google.maps.TravelMode[travel_mode]}, function(response, status){
if (status== 'OK'){
var route=response.routes[0];
UniCpo.setValueRoutes( route, option_slug, route.legs.length, map_type, field_name );
directionsDisplay.setDirections( response );
uni_cpo_form_processing()}else {
...
return !1}
uni_cpo_form_processing()}else if ( UniCpo.calc_on && UniCpo.calc_btn_on ){
...
var $elImageContainer=$defaultWcImages.first()}else {
...
if ( ! unicpo.total_off ){
jQuery(".single_add_to_cart_button").after('<div class="uni-cpo-total"></div>')}}else if ( UniCpo.calc_on && UniCpo.calc_btn_on ){
...
'min': elVal,
onFinish: function(){
if ( unicpo.calc_on== !0 && unicpo.calc_btn_on== !1 ){
if ( UniCpo._request_sent ){
return !1}
uni_cpo_form_processing()}else if ( unicpo.calc_on== !0 && unicpo.calc_btn_on== !0 ){
jQuery('.single_add_to_cart_button').prop('disabled', !0)}},
...
jQuery('#'+$el.attr('id')+'-preview').val(value)},})}else {
$el.ionRangeSlider({
'from': elVal,
'min': elVal})}})}
...
uniValid=!0;
$elForm.parsley({
excluded: '[disabled], .qty, .uni-cpo-excluded-from-validation'}).validate();
...
priceSuffixTag=priceTag.next(".woocommerce-price-suffix")}else {
...
jQuery('#'+name_of_checkboxes+'-field-count').val(fields[name_of_checkboxes+'_count'])}else if ( elType== 'radio' && !$el.hasClass("uni-cpo-excluded-from-validation") ){
if ( jQuery('input[name="'+this.name+'"]:checked').length ){
if ( $el.prop('checked')== !0 ){
fields[this.name]=$el.val()}}else {
fields[this.name]=''}}else if ( elType== 'text' && !$el.hasClass("uni-cpo-excluded-from-validation") ){
...
jQuery('#'+this.name+'-field-duration').val(cpoDatesDuration)}else {
fields[this.name]=fields[this.name+'_enddate']}}else if ( $el.hasClass('js-uni-cpo-field-range_slider') ){
...
fields[this.name]=slider_data.result.from}else if ( $el.hasClass("js-uni-cpo-field-color_picker") ){
if ($el.val()){
fields[this.name]=$el.data('price')}}else if ( $el.hasClass("js-uni-cpo-field-google_maps-single") ){
...
fields[this.name+'_distance']=$distance.val()}}else {
if ( uniCpoIsNumber($el.val())== !1 ){
...
jQuery('#'+this.name+'-field-count').val( fields[this.name+'_count'] )}}else if ( elType== 'select-one' && !$el.hasClass("uni-cpo-excluded-from-validation") ){
fields[this.name]=$el.val()}else if ( elType== 'number' && !$el.hasClass("uni-cpo-excluded-from-validation") ){
if ( uniCpoIsNumber($el.val())== !1 ){
var n=$el.val().replace(/,/,".");
$el.val(n);
fields[this.name]=$el.val()}else {
...
var without_spaces=$el.val().replace(/ /g,"");
fields[this.name+'_count']=without_spaces.length;
jQuery('#'+this.name+'-field-count').val( fields[this.name+'_count'] )}else if ( ! $el.hasClass("uni-cpo-excluded-from-validation") ){
fields[this.name]=$el.val()}
...
uni_cpo_ajax_request( fields, priceTag, priceSuffixTag )}else {
...
unicpo.reg_vars=jQuery.extend({}, response.reg_vars)}else {
...
if ( typeof $msgOrderingDisabled !== 'undefined' ){
priceTag.html('');
$msgOrderingDisabled.slideDown()}}else {
...
$totalTag.html(unicpo.total_text_start+' '+fields.uni_cpo_quantity+' '+unicpo.total_text_end+' <span class="uni-cpo-total-sum">'+unicpo.price_vars.total+'</span> (<span class="uni-cpo-total-incl-excl-tax">'+unicpo.price_vars.total_suffix+'</span>)')}else if ( ! unicpo.total_off && ! unicpo.price_vars.total_suffix ){
...
UniCpo._request_sent=!1;
jQuery( document.body ).trigger( 'cpo_options_data_ajax_success_event', [ fields, response ] )}else if ( 'error'=== response.status ){
$elAddToCartForm.unblock();
UniCpo._request_sent=!1;
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/uni-woo-custom-product-options/assets/js/uni-cpo-front-footer.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/ui/core.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/ui/widget.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/ui/mouse.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/ui/draggable.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/ui/slider.min.js\n- Error message: "+ e.message);}
try{
/*!
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/jquery/jquery.ui.touch-punch.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-admin/js/iris.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-admin/js/color-picker.min.js\n- Error message: "+ e.message);}

try{
window.lazySizesConfig = window.lazySizesConfig || {};    
}
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/lazy-load-optimizer/assets/frontend/js/lazysizes.min.js - BEFORE\n- Error message: "+ e.message);}
try{
/*! lazysizes - v5.2.0 */
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/lazy-load-optimizer/assets/frontend/js/lazysizes.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-includes/js/wp-embed.min.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/js_composer/assets/js/dist/js_composer_front.min.js\n- Error message: "+ e.message);}
