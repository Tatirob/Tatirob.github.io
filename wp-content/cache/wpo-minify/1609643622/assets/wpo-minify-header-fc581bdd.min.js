...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/weather-effect/assets/js/christmas-snow/christmas-snow.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: http://localhost/bk/wp-content/plugins/weather-effect/assets/js/snow-falling/snow-falling.js\n- Error message: "+ e.message);}
