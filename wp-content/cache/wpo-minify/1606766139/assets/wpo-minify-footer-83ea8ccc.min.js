...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.kestedamena.com/wp-content/plugins/cool-timeline-pro/js/jquery.prettyPhoto.js\n- Error message: "+ e.message);}
try{
(function($){'use strict';$.fn.sectionScroll=function(options){var $container=this,$window=$(window),$section_number=1,f_lastId,lastId,settings=$.extend({bulletsClass:'section-bullets',sectionsClass:'scrollable-section',scrollDuration:1000,titles:!0,topOffset:0,easing:'',id:'',position:'left'},options);var tm_id=settings.id+'-navi';var cont_cls='';var $sections2=$("#"+settings.id).find('.'+settings.sectionsClass);var $sections=$('.'+settings.sectionsClass);if(settings.position=="left"||settings.position=="right"){cont_cls='ctl-bullets-container'}else if(settings.position=="bottom"){cont_cls='ctl-footer-bullets-container'}
var $bullets=$('<div id="'+tm_id+'" class="'+cont_cls+'"><ul class="'+settings.bulletsClass+'"></ul></div>').prependTo($container).find('ul');var bullets_html='';$sections2.each(function(){var $this=$(this);var title=$this.data('section-title')||'';var cls='';$this.attr('id','scrollto-section-'+tm_id+'-'+title);cls=$this.data("cls");var bullet_title=settings.titles?'<span>'+title+'</span>':'';bullets_html+='<li class="year-'+title+" "+cls+' "><a title="'+title+'" href="#scrollto-section-'+tm_id+'-'+title+'">'+bullet_title+'</a></li>';$section_number++});var $bullets_items=$(bullets_html).appendTo($bullets);var scrollItems=$bullets_items.map(function(){var item=$($(this).find('a').attr('href'));if(item[0]){return item}});$bullets_items.on('click',function(e){var href=$(this).find('a').attr('href'),offsetTop=href==='#'?0:$(href).offset().top;$('html, body').stop().animate({scrollTop:offsetTop-settings.topOffset},settings.scrollDuration,settings.easing,function(){$container.trigger('scrolled-to-section').stop()});e.preventDefault()});$window.on('scroll',function(){var fromTop=$window.scrollTop()+($window.height()/2.5);var cur=scrollItems.map(function(){if($(this).offset().top<fromTop){return this}});cur=cur.length>0?cur[cur.length-1]:[];var id=cur[0]?cur[0].id:'';if(lastId!==id){$sections2.removeClass('active-section');$(cur).addClass('active-section');$bullets_items.removeClass('active').find('a[href="#'+id+'"]').parent().addClass('active');lastId=id;$.fn.sectionScroll.activeSection=cur;$container.trigger('section-reached')}});$(function(){$window.scroll()});return $container}}(jQuery));

}
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.kestedamena.com/wp-content/plugins/cool-timeline-pro/js/jquery.section-scroll.js\n- Error message: "+ e.message);}
try{
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.kestedamena.com/wp-content/plugins/cool-timeline-pro/js/jquery.viewportchecker.js\n- Error message: "+ e.message);}
try{
jQuery('document').ready(function($){$(".cool_timeline").find("a[class^='ctl_prettyPhoto']").prettyPhoto({social_tools:!1});$(".cool_timeline").find("a[rel^='ctl_prettyPhoto']").prettyPhoto({social_tools:!1});var ele_width=$(".cool_timeline").find('.timeline-content').find(".ctl_info").width();ele_width=ele_width-20;var value=ele_width
value*=1;var valueHeight=Math.round((value/4)*3);var animation=$(".cool_timeline").find('.ctl_flexslider').attr('data-animation');var slideshow_op=$(".cool_timeline").find('.ctl_flexslider').attr('data-slideshow');if(slideshow_op=="true"){slideshow=!0}else if(slideshow_op=="false"){slideshow=!1}else{slideshow=!0}
var animationSpeed=$(".cool_timeline").find('.ctl_flexslider').attr('data-animationSpeed');$(".cool_timeline").find('.full-width > iframe').height(valueHeight);$(".cool_timeline").find('.ctl_flexslider').flexslider({animation:animation,slideshow:slideshow,rtl:!0,slideshowSpeed:animationSpeed,smoothHeight:!0});var pagination=$(".cool_timeline").attr('data-pagination');var pagination_position=$(".cool_timeline").attr('data-pagination-position');var bull_cls='';var position='';if(pagination_position=="left"){bull_cls='section-bullets-left';position='left'}else if(pagination_position=="right"){bull_cls='section-bullets-right';position='right'}else if(pagination_position=="bottom"){bull_cls='section-bullets-bottom';position='bottom'}
$('.cool_timeline').each(function(index){var id=$(this).attr("id");if(id!==undefined){if(pagination=="yes"){$('body').sectionScroll({bulletsClass:bull_cls,sectionsClass:'scrollable-section',scrollDuration:1500,titles:!0,topOffset:2,easing:'',id:id,position:position,})}}});if(pagination=="yes"){$('.ctl-bullets-container').hide();$('.cool_timeline').each(function(){if(typeof $(this).attr("id")!==typeof undefined&&$(this).attr("id")!==!1){var id="#"+$(this).attr("id");var nav_id="#"+$(this).attr("id")+'-navi';$(nav_id).find('li').removeClass('active');var offset=$(id).offset();var t_height=$(id).height();$(window).scroll(function(){var isElementInView=Utils.isElementInView($(id),!1);if(isElementInView){$(nav_id).show()}else{$(nav_id).hide()}})}})}
$(".cooltimeline_cont").each(function(index){var timeline_id=$(this).attr('id');var animations=$("#"+timeline_id).attr("data-animations");if(animations!="none"){var addtocls='ctlvisible animated '+animations;$("#"+timeline_id).find('.timeline-content').addClass("ctlhidden").viewportChecker({classToAdd:addtocls,classToRemove:'ctlhidden',removeClassAfterAnimation:!1,offset:100})}});function Utils(){}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.kestedamena.com/wp-content/plugins/cool-timeline-pro/js/ctl_scripts.js\n- Error message: "+ e.message);}
try{
jQuery(function($){if(typeof ctlloadmore!='undefined'&&typeof ctlloadmore.attribute!='undefined'){var page=2;var loading=!1;if($('.cool_timeline').find('.ctl_load_more').attr("data-max-num-pages")==1){$('.cool_timeline').find('.ctl_load_more').hide()}
...
var allAtts=ctlloadmore.attribute;var last_year=timeline_wrp.find('.timeline-year:last').data('section-title');var alternate=timeline_wrp.find('.timeline-post:last').data('alternate');if($('.ct-cat-filters').length&&$('.ct-cat-filters').hasClass('active-category')){var filterCat=$('.active-category').data('term-slug');allAtts.category=filterCat}
if(!loading){$(this).html(loading_text);var max_pages=$(this).attr("data-max-num-pages");var max_page_num=parseInt(max_pages)+1;loading=!0;var data={action:'ctl_ajax_load_more',page:page,last_year:last_year,alternate:alternate,attribute:allAtts};$.post(ctlloadmore.url,data,function(res){if(res.success){if(type=="compact"){var $grid=timeline_wrp.find('.clt-compact-cont').append(res.data);ctl_compact_settings($grid)}else{timeline_wrp.find('.cooltimeline_cont').append(res.data)}
if(type!="compact"){enable_navi(timeline_wrp)}
re_enable_pp(timeline_wrp);button.html(org_label);page=page+1;loading=!1;if(page>=max_page_num){$('.ctl_load_more').hide()}}else{}}).fail(function(xhr,textStatus,e){console.log(xhr.responseText)})}})}
...
loading=!0;var data={action:action,termslug:termSlug,attribute:all_attrs};$.post(ajax_url,data,function(res){if(res.success){if(type=="compact"){parent_wrp.find('.clt-compact-cont').append('<div class="center-line"></div>');var $grid=parent_wrp.find('.clt-compact-cont').append(res.data);ctl_compact_settings($grid)}else{parent_wrp.find('.cooltimeline_cont').append(res.data)}
loading=!1;preloader.hide();$(parent_wrp).find(".timeline-main-title").text(cat_name);$(parent_wrp).find(".no-content").hide();enable_navi(parent_wrp);re_enable_pp(parent_wrp)}else{}}).fail(function(xhr,textStatus,e){console.log(xhr.responseText)})}});function ctl_compact_settings($grid){if($grid!=undefined){$grid.masonry('reloadItems');$grid.masonry('layout');$grid.on('layoutComplete',function(event,laidOutItems){var elems=$grid.masonry('getItemElements');var left_plus=0;var right_plus=0;$.each(elems,function(index,value){var thisEle=$(this);var leftPos=thisEle.position().left;if(leftPos<=0){var topPos=thisEle.position().top+left_plus;thisEle.addClass('ctl-left')}else{var topPos=thisEle.position().top+right_plus;thisEle.addClass('ctl-right')}
if(thisEle.next('.timeline-post').length>0){var next_leftPos=thisEle.next().position().left;if(next_leftPos<=0){var second_topPos=thisEle.next().position().top+left_plus}else{var second_topPos=thisEle.next().position().top+right_plus}
...
var firstHeight=thisEle.outerHeight(!0);var firstBottom=topPos+firstHeight+60;thisEle.css({'top':topPos+'px'});$('.compact-wrapper .cooltimeline_cont').css({'height':firstBottom+'px'})})})}}
function re_enable_pp(timeline_wrp){if(timeline_wrp!=undefined){timeline_wrp.find("a[class^='ctl_prettyPhoto']").prettyPhoto({social_tools:!1});timeline_wrp.find("a[rel^='ctl_prettyPhoto']").prettyPhoto({social_tools:!1})}}
function enable_navi(timeline_wrp){if(timeline_wrp!=undefined){var wrp_id=timeline_wrp.attr("id");$("#"+wrp_id+'-navi').remove();var pagination=timeline_wrp.attr('data-pagination');var pagination_position=timeline_wrp.attr('data-pagination-position');var bull_cls='';var position='';if(pagination_position=="left"){bull_cls='section-bullets-left';position='left'}else if(pagination_position=="right"){bull_cls='section-bullets-right';position='right'}else if(pagination_position=="bottom"){bull_cls='section-bullets-bottom';position='bottom'}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://www.kestedamena.com/wp-content/plugins/cool-timeline-pro/js/load-more.js\n- Error message: "+ e.message);}
