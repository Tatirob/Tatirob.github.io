    ...
    class UT_Hero_Animation_CSS extends UT_Custom_CSS {
        ...
        public function custom_css() {
            ...
            <style id="ut-hero-animation-css" type="text/css">
				...
				<?php if( apply_filters( 'ut_show_hero', false ) && ( $ut_hero_type == 'image' || $ut_hero_type == 'splithero' || $ut_hero_type == 'tabs' || $ut_hero_type == 'video' || $ut_hero_type == 'imagefader' ) ) : ?>
                    ...
                    @media(min-width: 768px) {
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero.heroKenBurns .parallax-image-container {
                            ...
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                            -webkit-animation: heroKenBurns <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                               -moz-animation: heroKenBurns <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                                    animation: heroKenBurns <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                        ...
                        .ut-js #ut-sitebody.ut-hero-image-animated #ut-hero.heroKenBurnsOut .parallax-image-container {
                            ...
                            -webkit-animation-fill-mode: both;
                                    animation-fill-mode: both;
                            -webkit-animation: heroKenBurnsOut <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                               -moz-animation: heroKenBurnsOut <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                                    animation: heroKenBurnsOut <?php echo ut_collect_option( 'ut_hero_image_animation_effect_kenburns_timer', '150' ); ?>s <?php echo $this->get_css_easing( ut_collect_option( 'ut_hero_image_animation_effect_easing', 'ease' ) ); ?>;
                            -webkit-animation-fill-mode: forwards;
                                    animation-fill-mode: forwards;
                        }
