            ...
            <?php if( ut_collect_option('ut_post_title', 'on', 'ut_') == 'on' ) : ?>
                ...
                <header class="entry-header">
                    ...
                    <?php if( get_post_meta( get_the_ID(), 'ut_post_custom_title', true ) ) : ?>
                        ...
                        <h1 class="entry-title element-with-custom-line-height"><?php echo get_post_meta( get_the_ID(), 'ut_post_custom_title', true ); ?></h1>
                    
                    <?php else : ?>
                    
                        <h1 class="entry-title element-with-custom-line-height"><?php the_title(); ?></h1>
