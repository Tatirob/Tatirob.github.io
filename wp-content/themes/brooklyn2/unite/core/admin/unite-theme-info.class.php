...
class UT_Theme_Info {
    ...
    public function theme_environment() {
        ...
        $this->current_config['report']['theme']['sitemode']  = ot_get_option( 'ut_site_layout', 'onepage' );
                            ...
                            <div class="ut-dashboard-table brooklyn-environment">
                                ...
                                <table class="form-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr valign="top">
                                            <th scope="row"><?php esc_html_e( 'Site Mode:', 'unite-admin' ); ?></th>
                                            <td><?php echo ot_get_option( 'ut_site_layout', 'onepage' ) == 'onepage' ? 'OnePage' : 'Multisite'; ?></td>
                                        </tr>
